...
def test_scan_arena_tournaments_returns_counts(monkeypatch):
    ...
    monkeypatch.setattr("gameplay.tasks.arena.run_due_arena_coop_events", lambda *, limit: limit // 2)
    monkeypatch.setattr(
        "gameplay.tasks.arena.cleanup_expired_arena_coop_events",
...
def test_scan_arena_tournaments_includes_coop_counts(monkeypatch):
    ...
    monkeypatch.setattr("gameplay.tasks.arena.run_due_arena_coop_events", lambda *, limit: 4)
    monkeypatch.setattr(
        "gameplay.tasks.arena.cleanup_expired_arena_coop_events",
...
def test_scan_arena_tournaments_aggregates_database_failures(monkeypatch):
    ...
    monkeypatch.setattr(
        "gameplay.tasks.arena.run_due_arena_coop_events", lambda *, limit: calls.append(f"coop:{limit}") or 4
    )
    monkeypatch.setattr(
        "gameplay.tasks.arena.cleanup_expired_arena_coop_events",
...
def test_scan_arena_tournaments_programming_error_bubbles_up(monkeypatch):
    ...
    monkeypatch.setattr(
        "gameplay.tasks.arena.run_due_arena_coop_events",
