...
from gameplay.services.virtual_player_core import gate_d1_exit_workflow


class Command(BaseCommand):
    help = "Verify frozen evidence and exit virtual-player Gate D1; defaults to dry-run."
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        summary = invoke_application_service(
            lambda: gate_d1_exit_workflow.exit_gate_d1_operation(
        ...
        write_operation_summary(
            ...
            details=(
                ...
                ("bootstrap_mode", summary.snapshot.bootstrap_mode.value),
