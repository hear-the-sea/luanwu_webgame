...
DEFAULT_ARCHETYPE_PACING: dict[str, ArchetypePacing] = {
    "balanced": ArchetypePacing(
        ...
        building_targets=("tax_office", "latrine", "tavern", "bathhouse", "farm", "granary", "silver_vault"),
    ...
    "rich": ArchetypePacing(
        ...
        max_parallel_training=1,
        building_targets=("tax_office", "silver_vault", "tavern", "bathhouse", "latrine", "farm", "granary"),
        technology_targets=("architecture", "farming"),
    ...
    "dojo": ArchetypePacing(
        ...
        building_targets=("tax_office", "bathhouse", "latrine", "tavern", "farm", "silver_vault", "granary"),
        technology_targets=("architecture", "farming"),
    ...
    "guard": ArchetypePacing(
        ...
        max_parallel_training=1,
        building_targets=("tax_office", "silver_vault", "bathhouse", "latrine", "tavern", "farm", "granary"),
        technology_targets=("architecture", "farming"),
